          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-lg p-6 shadow-sm border">
                ...
                <p className="text-gray-600">Generates MCP tools for all PayloadCMS collections automatically</p>
              </div>
      ...
      collections: 'all',
            ...
            <div className="text-center mt-12 pt-8 border-t border-gray-200">
              <p className="text-gray-600">
                Made with ❤️ by <a href="https://github.com/Antler-Digital" className="text-blue-600 hover:text-blue-500">Antler Digital</a>
              </p>
